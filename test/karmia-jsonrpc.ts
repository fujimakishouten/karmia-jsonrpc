...
import KarmiaJSONRPC = require("../");


// Variables
const expect = require("expect.js");
const context = new KarmiaContext();
const jsonrpc = new KarmiaJSONRPC();
...
describe('karmia-jsonrpc', function () {
    describe('RPC', function () {
        ...
        it('Batch request', function (done) {
            ...
            jsonrpc.call(context, data).then(function (result) {
                expect(result.status).to.be(200);
                result.body.forEach(function (value: {[index: string]: any}, index: number) {
